                        ...
                        <div class="container__account">
                            ...
                            <form action="" class="account__form">
                                <div class="account__info">
                                    ...
                                    <div class="account-info__group">
                                        <label for="phone" class="account-info__label"><a href="" class="account-info__link">Đổi mật khẩu</a></label>
                                ...
                                <div class="account__avatar">
                                    <div class="account-avatar__avtbox">
                                        <img src="./assets/img/account/avt.jpg" alt="" class="account-avatar__img">
